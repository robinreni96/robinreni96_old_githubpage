...
title: "Running parallel ML Training & Prediction models using AWS Lambda service"
...
* You can see a **function.zip** file inside your **aws_lambda folder** . It means your 

#### Step 4: Exporting Deployment Package & Lambda Invocation : 
Now you have your **lambda function in aws configured** and the **function.zip** depolyment package in your local system is ready . 
There are three ways of implementing functions in lambda:
